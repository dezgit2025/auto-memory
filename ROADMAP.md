...
- OSS-001: Reddit launch and OpenAI application. Preparation complete September 20; drafts/links reviewed and reminder verified; launch September 21–27. [Plan](launch/launch-plan.md), [tasks](launch/tasks.md). Refresh facts/rules before posting; follow up October 4.
- OSS-002: Reproducible recall evaluation. Deferred, uncommitted; establish benefit beyond stars/forks. Reconsider after launch feedback or funding; separately scope metrics, fixtures and budget.
